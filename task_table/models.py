...
class TaskTable(models.Model):
    ...
    name: models.CharField = models.CharField(max_length=70, help_text="название таблицы")
    ...
    term: models.IntegerField = models.IntegerField(null=True, blank=True, help_text="срок")
    status: models.BooleanField = models.BooleanField(default=True, help_text="статус")
    work: models.BooleanField = models.BooleanField(default=True, help_text="взять в работу задачу")
