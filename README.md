...
RESTful API — обеспечивает CRUD операции для сотрудников и задач, а также предоставляет два специальных эндпоинта для 
...
Telegram Bot — предоставляет удобный интерфейс для сотрудников и менеджеров для быстрого доступа к задачам и их 
