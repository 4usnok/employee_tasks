...
команда для подгрузки: `git pull origin work-for-nikolay`
проверка файлов на ветке: `git ls-tree -r origin/work-for-nikolay`, где ветка work-for-nikolay ветка разработчика
